              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-2">
                  ...
                  <div className="space-y-1">
                    {Object.entries(data.spikeDetection).map(([key, detection]) => (
                ...
                <div className="space-y-2">
                  ...
                  <div className="space-y-1">
                    {Object.entries(data.rollingAverages).map(([key, averages]) => (
                      <div key={key} className="text-sm">
                        <span className="capitalize">{key.replace(/([A-Z])/g, ' $1')}:</span>
                        <span className="ml-2">
                          7D: {averages['7d']?.toFixed(0)}, 
                          30D: {averages['30d']?.toFixed(0)}, 
                          90D: {averages['90d']?.toFixed(0)}
                        </span>
                      </div>
                    ))}
                  </div>
